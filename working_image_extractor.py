...
# Process PDF
print("🚀 GPU Processing with Working Image Extraction...")
...
# Extract and save images using get_image(doc) method
...
if hasattr(doc, 'pictures') and doc.pictures:
    ...
    for i, picture in enumerate(doc.pictures):
        try:
            # Use get_image(doc) method with document parameter
            img_data = picture.get_image(doc)
