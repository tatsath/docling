#!/usr/bin/env python3
"""
Download all essential Docling models
"""
...
def download_all_models():
    """Download all essential Docling models"""
    print("=== DOCLING COMPLETE MODEL DOWNLOADER ===")
    print()
    ...
    # Correct model repositories for Docling
    model_repos = {
        "TableFormer": "microsoft/table-transformer-structure",
        "Layout": "microsoft/layoutlmv3-base", 
        "EasyOCR": "JaidedAI/EasyOCR",
        "TableFormer_Alt": "microsoft/table-transformer",  # Alternative
        "Layout_Alt": "microsoft/layoutlmv2-base",  # Alternative
    }
